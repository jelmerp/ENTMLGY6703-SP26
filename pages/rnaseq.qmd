...
4. Uses **short reads** (≤150 bp) that do not cover full transcripts but do uniquely ID genes
...
::: {.callout-note appearance="simple"}
_When I refer to RNA-Seq from now on, this specific type of RNA-Seq is implied._
:::
...
- Response of maize to infection with _Pantoea_  with and without an effector gene
  _(Mackey lab, HCS)_
...
- _Plasmodium relictum_ -- higher virulence, lower tranmission rate
- _Plasmodium cathemerium_ -- lower virulence, higher tranmission rate

## The Garrigós et al. experimental design

![](../img/exp-design_a.png){.lightbox fig-align="center" width="75%" fig-alt="A diagram showing the experimental design of the Garrigós et al. 2025 study."}
...
![](../img/exp-design_b.png){.lightbox fig-align="center" width="75%" fig-alt="A diagram showing the experimental design of the Garrigós et al. 2025 study."}
...
![](../img/exp-design_c.png){.lightbox fig-align="center" width="75%" fig-alt="A diagram showing the experimental design of the Garrigós et al. 2025 study."}
...
![](../img/exp-design_c.png){.lightbox fig-align="center" width="65%" fig-alt="A diagram showing the experimental design of the Garrigós et al. 2025 study."}
...
![](../img/exp-design_d.png){.lightbox fig-align="center" width="65%" fig-alt="A diagram showing the experimental design of the Garrigós et al. 2025 study."}
...
<details><summary>
*Which type of RNA do the red bars followed by [AAAAAAA]{style="color:red;"} represent?*
&nbsp; <span style="color:darkolivegreen;">{{< fa comments >}}</span>
</summary>
...
the process is fairly standardized and suitable to be outsourced. 
:::
...
No, it doesn't, because of splicing.
This means that a read can align partially to two different exons,
skipping the intron in between.
"Regular" genome alignment would not be able to handle this properly --
see the next slides.
</details>
...
![](../img/PCA.jpeg){fig-align="center" width="85%"}

:::legend2
Fig. 1 from @garrigós2025
:::
...
see [this video](https://www.youtube.com/watch?v=HMOI_lkzW08) (short overview)
and [this video](https://www.youtube.com/watch?v=FgakZw6K1QQ) (more detailed).
:::
...
Functional **enrichment analysis** helps with this, 
asking whether certain **functional categories** of genes are
statistically overrepresented among DEGs.
...
- **Gene Ontology (GO)**\
  Have a hierarchical structure with more specific terms grouping into
  more general terms
- **Kyoto Encyclopedia of Genes and Genomes (KEGG)**\
  Less general than GO, has pathways whose genes can be drawn and
  connected in diagrams
